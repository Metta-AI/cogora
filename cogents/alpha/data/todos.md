...
- [ ] Fix wipe bug (~7% seeds) — map-dependent, agents die before establishing territory.
...
- [x] Wave/MaxPressure strategies failed (1.63-1.88). Economy-first doesn't work.
...
- [x] CONFIRMED: vanilla base underperforms customized (AlphaCyborg) in some cases.

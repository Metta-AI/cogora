...
from cvc_cog.provider_utils import get_default_anthropic_model
from cvc_cog.providers.anthropic import build_anthropic_client
from cvc_cog.runtime.artifacts import ArtifactStore
from cvc_cog.runtime.pilot_runtime_common import (
    DEFAULT_GOAL,
    DEFAULT_MAX_TOKENS,
...
from cvc_cog.secret_utils import resolve_api_key
